...
import com.ykyong.OAuthServer.dto.Privilege;
...
public class UserRepositoryJdbc implements UserRepository {
    ...
    @Override
    @CacheEvict(value = com.ykyong.OAuthServer.util.CacheConstants.USER_CACHE, key = "#user.username()")
    ...
    @Override
    @Cacheable(value = com.ykyong.OAuthServer.util.CacheConstants.USER_CACHE, key = "#username")
